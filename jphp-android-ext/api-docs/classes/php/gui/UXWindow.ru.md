...
> [UXForm](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXForm.ru.md), [UXPopupWindow](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXPopupWindow.ru.md)
...
- `->`[`scene`](#prop-scene) : [`UXScene`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXScene.ru.md) - _Сцена._
- `->`[`x`](#prop-x) : `double`
- `->`[`y`](#prop-y) : `double`
...
- `->`[`layout`](#prop-layout) : [`UXPane`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/layout/UXPane.ru.md)
- `->`[`children`](#prop-children) : [`UXList`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXList.ru.md) - _Компоненты._
