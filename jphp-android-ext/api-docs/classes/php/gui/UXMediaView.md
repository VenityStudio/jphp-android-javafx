...
- **class** `UXMediaView` (`php\gui\UXMediaView`) **extends** [`UXNode`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXNode.md)
- **package** `gui`
