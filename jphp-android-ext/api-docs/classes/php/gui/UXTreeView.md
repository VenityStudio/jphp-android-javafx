...
- **class** `UXTreeView` (`php\gui\UXTreeView`) **extends** [`UXControl`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXControl.md)
- **package** `gui`
...
- `->`[`root`](#prop-root) : [`UXTreeItem`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXTreeItem.md)
...
- `->`[`focusedItem`](#prop-focuseditem) : [`UXTreeItem`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/UXTreeItem.md)
