...
- **класс** `UXScrollEvent` (`php\gui\event\UXScrollEvent`) **унаследован от** [`UXEvent`](https://github.com/VenityStudio/android/tree/master/jphp-android-ext/api-docs/classes/php/gui/event/UXEvent.ru.md)
- **пакет** `gui`
